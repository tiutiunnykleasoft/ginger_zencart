...
define('MODULE_PAYMENT_'.$method_name.'_STATUS_TEXT', "Activer MobilePay");
define('MODULE_PAYMENT_'.$method_name.'_STATUS_DESCRIPTION', "Voulez-vous activer MobilePay?");

define('MODULE_PAYMENT_'.$method_name.'_SORT_ORDER_TEXT', "Ordre de tri pour MobilePay");
...
define('MODULE_PAYMENT_'.$method_name.'_ERROR_ALREADY_INSTALLED', "Le module Mobile Pay est déjà installé.");

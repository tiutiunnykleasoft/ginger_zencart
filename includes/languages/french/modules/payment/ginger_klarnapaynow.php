...
define('MODULE_PAYMENT_'.$method_name.'_STATUS_TEXT', "Activer Klarna Pay Now");
define('MODULE_PAYMENT_'.$method_name.'_STATUS_DESCRIPTION', "Voulez-vous activer Klarna Pay Now?");

define('MODULE_PAYMENT_'.$method_name.'_SORT_ORDER_TEXT', "Ordre de tri pour Klarna Pay Now");
...
define('MODULE_PAYMENT_'.$method_name.'_ERROR_ALREADY_INSTALLED', "Le module Klarna Pay Now est déjà installé.");

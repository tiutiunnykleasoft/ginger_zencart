...
define('MODULE_PAYMENT_'.$method_name.'_TEXT_TITLE', "Cartes du credit");
...
define('MODULE_PAYMENT_'.$method_name.'_STATUS_TEXT', "Activer Cartes du credit");
define('MODULE_PAYMENT_'.$method_name.'_STATUS_DESCRIPTION', "Voulez-vous activer Cartes du credit?");

define('MODULE_PAYMENT_'.$method_name.'_SORT_ORDER_TEXT', "Ordre de tri pour Cartes du credit");
...
define('MODULE_PAYMENT_'.$method_name.'_ERROR_ALREADY_INSTALLED', "Le module Cartes/Debit du credit est déjà installé.");

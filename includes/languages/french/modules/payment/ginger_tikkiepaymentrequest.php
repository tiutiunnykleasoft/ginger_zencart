...
define('MODULE_PAYMENT_'.$method_name.'_STATUS_TEXT', "Activer Tikkie Payment Request");
define('MODULE_PAYMENT_'.$method_name.'_STATUS_DESCRIPTION', "Voulez-vous activer Tikkie Payment Request?");

define('MODULE_PAYMENT_'.$method_name.'_SORT_ORDER_TEXT', "Ordre de tri pour Tikkie Payment Request");
...
define('MODULE_PAYMENT_'.$method_name.'_ERROR_ALREADY_INSTALLED', "Le module Tikkie est déjà installé.");

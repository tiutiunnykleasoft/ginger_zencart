...
define('MODULE_PAYMENT_'.$method_name.'_STATUS_TEXT', "Activer PayPal");
define('MODULE_PAYMENT_'.$method_name.'_STATUS_DESCRIPTION', "Voulez-vous activer PayPal?");

define('MODULE_PAYMENT_'.$method_name.'_SORT_ORDER_TEXT', "Ordre de tri pour PayPal");
...
define('MODULE_PAYMENT_'.$method_name.'_ERROR_ALREADY_INSTALLED', "Le module PayPal est déjà installé.");

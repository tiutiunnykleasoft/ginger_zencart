...
define('MODULE_PAYMENT_'.$method_name.'_STATUS_TEXT', "Activer Sofort");
define('MODULE_PAYMENT_'.$method_name.'_STATUS_DESCRIPTION', "Voulez-vous activer Sofort?");

define('MODULE_PAYMENT_'.$method_name.'_SORT_ORDER_TEXT', "Ordre de tri pour Sofort");
...
define('MODULE_PAYMENT_'.$method_name.'_ERROR_ALREADY_INSTALLED', "Le module SOFORT est déjà installé.");

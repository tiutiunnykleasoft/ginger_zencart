...
define('MODULE_PAYMENT_'.$method_name.'_STATUS_TEXT', "Activer Payconiq");
define('MODULE_PAYMENT_'.$method_name.'_STATUS_DESCRIPTION', "Voulez-vous activer Payconiq?");

define('MODULE_PAYMENT_'.$method_name.'_SORT_ORDER_TEXT', "Ordre de tri pour Payconiq");
...
define('MODULE_PAYMENT_'.$method_name.'_ERROR_ALREADY_INSTALLED', "Le module Payconiq est déjà installé.");

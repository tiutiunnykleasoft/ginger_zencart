...
define('MODULE_PAYMENT_'.$method_name.'_STATUS_TEXT', "Activer Apple Pay");
define('MODULE_PAYMENT_'.$method_name.'_STATUS_DESCRIPTION', "Voulez-vous activer Apple Pay?");

define('MODULE_PAYMENT_'.$method_name.'_SORT_ORDER_TEXT', "Ordre de tri pour Apple Pay");
...
define('MODULE_PAYMENT_'.$method_name.'_ERROR_ALREADY_INSTALLED', "Le module Apple Pay est déjà installé.");

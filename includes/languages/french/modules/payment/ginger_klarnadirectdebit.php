...
define('MODULE_PAYMENT_'.$method_name.'_TEXT_DESCRIPTION', "Méthode de paiement fournie par Ginger Tooling.");
...
define('MODULE_PAYMENT_'.$method_name.'_STATUS_TEXT', "Activer Klarna Direct Debit");
define('MODULE_PAYMENT_'.$method_name.'_STATUS_DESCRIPTION', "Voulez-vous activer Klarna Direct Debit?");

define('MODULE_PAYMENT_'.$method_name.'_SORT_ORDER_TEXT', "Ordre de tri pour Klarna Direct Debit");
...
define('MODULE_PAYMENT_'.$method_name.'_ERROR_ALREADY_INSTALLED', "Le module Klarna Direct Debit est déjà installé.");

...
define('MODULE_PAYMENT_'.$method_name.'_STATUS_TEXT', "Activer Bancontact");
define('MODULE_PAYMENT_'.$method_name.'_STATUS_DESCRIPTION', "Voulez-vous activer Bancontact?");

define('MODULE_PAYMENT_'.$method_name.'_SORT_ORDER_TEXT', "Ordre de tri pour Bancontact");
...
define('MODULE_PAYMENT_'.$method_name.'_ERROR_ALREADY_INSTALLED', "Le module Bancontact est déjà installé.");

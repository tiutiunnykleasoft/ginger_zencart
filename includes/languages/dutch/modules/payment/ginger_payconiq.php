...
define('MODULE_PAYMENT_'.$method_name.'_STATUS_TEXT', "Schakel Payconiq module in");
define('MODULE_PAYMENT_'.$method_name.'_STATUS_DESCRIPTION', "Wilt u die Payconiq module inschakelen?");

define('MODULE_PAYMENT_'.$method_name.'_SORT_ORDER_TEXT', "Sorteervolgorde voor Payconiq");

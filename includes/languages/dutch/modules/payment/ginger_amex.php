...
define('MODULE_PAYMENT_'.$method_name.'_STATUS_TEXT', "Schakel American Express module in");
define('MODULE_PAYMENT_'.$method_name.'_STATUS_DESCRIPTION', "Wilt u American Express inschakelen?");

define('MODULE_PAYMENT_'.$method_name.'_SORT_ORDER_TEXT', "Sorteervolgorde voor American Express");
...
define('MODULE_PAYMENT_'.$method_name.'_ERROR_ALREADY_INSTALLED', "De AMEX module is al geïnstalleerd.");

...
define('MODULE_PAYMENT_'.$method_name.'_TEXT_TITLE', "PayPal");
...
define('MODULE_PAYMENT_'.$method_name.'_STATUS_TEXT', "Schakel PayPal module in");
define('MODULE_PAYMENT_'.$method_name.'_STATUS_DESCRIPTION', "Wilt u die PayPal module inschakelen?");

define('MODULE_PAYMENT_'.$method_name.'_SORT_ORDER_TEXT', "Sorteervolgorde voor PayPal");
...
define('MODULE_PAYMENT_'.$method_name.'_ERROR_ALREADY_INSTALLED', "De PayPal module is al geïnstalleerd.");

...
define('MODULE_PAYMENT_'.$method_name.'_TEXT_TITLE', "Bancontact");
...
define('MODULE_PAYMENT_'.$method_name.'_STATUS_TEXT', "Inschakelen Bancontact");
define('MODULE_PAYMENT_'.$method_name.'_STATUS_DESCRIPTION', "Wilt u Bancontact inschakelen?");

define('MODULE_PAYMENT_'.$method_name.'_SORT_ORDER_TEXT', "Sorteervolgorde voor Bancontact");
...
define('MODULE_PAYMENT_'.$method_name.'_ERROR_ALREADY_INSTALLED', "De Bancontact module is al geïnstalleerd.");

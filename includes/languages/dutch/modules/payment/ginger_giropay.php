...
define('MODULE_PAYMENT_'.$method_name.'_STATUS_TEXT', "Schakel Giropay module in");
define('MODULE_PAYMENT_'.$method_name.'_STATUS_DESCRIPTION', "Wilt u Giropay inschakelen?");

define('MODULE_PAYMENT_'.$method_name.'_SORT_ORDER_TEXT', "Sorteervolgorde voor Giropay");
...
define('MODULE_PAYMENT_'.$method_name.'_ERROR_ALREADY_INSTALLED', "De GiroPay module is al geïnstalleerd.");

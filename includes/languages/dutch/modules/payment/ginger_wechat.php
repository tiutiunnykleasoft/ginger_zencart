...
define('MODULE_PAYMENT_'.$method_name.'_STATUS_TEXT', "Schakel WeChat module in");
define('MODULE_PAYMENT_'.$method_name.'_STATUS_DESCRIPTION', "Wilt u WeChat inschakelen?");

define('MODULE_PAYMENT_'.$method_name.'_SORT_ORDER_TEXT', "Sorteervolgorde voor WeChat");
...
define('MODULE_PAYMENT_'.$method_name.'_ERROR_ALREADY_INSTALLED', "De WeChat module is al geïnstalleerd.");

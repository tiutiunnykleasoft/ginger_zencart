...
define('MODULE_PAYMENT_'.$method_name.'_STATUS_TEXT', "Schakel Apple Pay module in");
define('MODULE_PAYMENT_'.$method_name.'_STATUS_DESCRIPTION', "Wilt u Apple Pay inschakelen?");

define('MODULE_PAYMENT_'.$method_name.'_SORT_ORDER_TEXT', "Sorteervolgorde voor Apple Pay");
...
define('MODULE_PAYMENT_'.$method_name.'_ERROR_ALREADY_INSTALLED', "De Apple Pay module is al geïnstalleerd.");

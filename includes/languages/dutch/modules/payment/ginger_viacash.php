...
define('MODULE_PAYMENT_'.$method_name.'_STATUS_TEXT', "Schakel Viacash module in");
define('MODULE_PAYMENT_'.$method_name.'_STATUS_DESCRIPTION', "Wilt u Viacash inschakelen?");

define('MODULE_PAYMENT_'.$method_name.'_SORT_ORDER_TEXT', "Sorteervolgorde voor Viacash");
...
define('MODULE_PAYMENT_'.$method_name.'_ERROR_ALREADY_INSTALLED', "De Viacash module is al geïnstalleerd.");

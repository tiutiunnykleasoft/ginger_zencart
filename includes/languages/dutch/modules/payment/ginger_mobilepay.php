...
define('MODULE_PAYMENT_'.$method_name.'_STATUS_TEXT', "Schakel MobilePay module in");
define('MODULE_PAYMENT_'.$method_name.'_STATUS_DESCRIPTION', "Wilt u MobilePay inschakelen?");

define('MODULE_PAYMENT_'.$method_name.'_SORT_ORDER_TEXT', "Sorteervolgorde voor MobilePay");
...
define('MODULE_PAYMENT_'.$method_name.'_ERROR_ALREADY_INSTALLED', "De Mobile Pay module is al geïnstalleerd.");

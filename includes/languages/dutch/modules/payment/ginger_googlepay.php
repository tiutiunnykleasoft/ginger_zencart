...
define('MODULE_PAYMENT_'.$method_name.'_STATUS_TEXT', "Schakel Google Pay module in");
define('MODULE_PAYMENT_'.$method_name.'_STATUS_DESCRIPTION', "Wilt u Google Pay inschakelen?");

define('MODULE_PAYMENT_'.$method_name.'_SORT_ORDER_TEXT', "Sorteervolgorde voor Google Pay");
...
define('MODULE_PAYMENT_'.$method_name.'_ERROR_ALREADY_INSTALLED', "De Google Pay module is al geïnstalleerd.");

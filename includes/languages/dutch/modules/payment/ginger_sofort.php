...
define('MODULE_PAYMENT_'.$method_name.'_STATUS_TEXT', "Schakel Sofort module in");
define('MODULE_PAYMENT_'.$method_name.'_STATUS_DESCRIPTION', "Wilt u Sofort inschakelen?");

define('MODULE_PAYMENT_'.$method_name.'_SORT_ORDER_TEXT', "Sorteervolgorde voor Sofort");
...
define('MODULE_PAYMENT_'.$method_name.'_ERROR_ALREADY_INSTALLED', "De SOFORT module is al geïnstalleerd.");

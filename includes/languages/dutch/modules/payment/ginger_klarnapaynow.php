...
define('MODULE_PAYMENT_'.$method_name.'_TEXT_TITLE', "Klarna Pay Now");
define('MODULE_PAYMENT_'.$method_name.'_TEXT_DESCRIPTION', "Betaalmethode verstrekt door Ginger lib.");
...
define('MODULE_PAYMENT_'.$method_name.'_STATUS_TEXT', "Schakel Klarna Pay Now module in");
define('MODULE_PAYMENT_'.$method_name.'_STATUS_DESCRIPTION', "Wilt u die Klarna Pay Now module inschakelen?");

define('MODULE_PAYMENT_'.$method_name.'_SORT_ORDER_TEXT', "Sorteervolgorde voor Klarna Pay Now");
...
define('MODULE_PAYMENT_'.$method_name.'_ERROR_ALREADY_INSTALLED', "De Klarna Pay Now module is al geïnstalleerd.");

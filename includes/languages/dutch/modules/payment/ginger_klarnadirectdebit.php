...
define('MODULE_PAYMENT_'.$method_name.'_TEXT_DESCRIPTION', "Betaalmethode verstrekt door Ginger Tooling.");
...
define('MODULE_PAYMENT_'.$method_name.'_STATUS_TEXT', "Schakel Klarna Direct Debit module in");
define('MODULE_PAYMENT_'.$method_name.'_STATUS_DESCRIPTION', "Wilt u Klarna Direct Debit inschakelen?");

define('MODULE_PAYMENT_'.$method_name.'_SORT_ORDER_TEXT', "Sorteervolgorde voor Klarna Direct Debit");
...
define('MODULE_PAYMENT_'.$method_name.'_ERROR_ALREADY_INSTALLED', "De Klarna Direct Debit module is al geïnstalleerd.");

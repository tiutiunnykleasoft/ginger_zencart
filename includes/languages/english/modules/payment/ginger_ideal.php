...
define('MODULE_PAYMENT_'.$method_name.'_ISSUER_SELECT', "Select your bank:");
...
define('MODULE_PAYMENT_'.$method_name.'_STATUS_TEXT', "Enable iDEAL");
define('MODULE_PAYMENT_'.$method_name.'_STATUS_DESCRIPTION', "Do you want to enable iDEAL?");

define('MODULE_PAYMENT_'.$method_name.'_SORT_ORDER_TEXT', "Sort order for iDEAL");

...
define('MODULE_PAYMENT_'.$method_name.'_STATUS_TEXT', "Enable PayPal");
define('MODULE_PAYMENT_'.$method_name.'_STATUS_DESCRIPTION', "Do you want to enable PayPal payment method?");

define('MODULE_PAYMENT_'.$method_name.'_SORT_ORDER_TEXT', "Sort order for PayPal");
...
define('MODULE_PAYMENT_'.$method_name.'_ERROR_ALREADY_INSTALLED', "The PayPal module is already installed.");

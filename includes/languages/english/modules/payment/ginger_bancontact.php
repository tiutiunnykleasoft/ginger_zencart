...
define('MODULE_PAYMENT_'.$method_name.'_TEXT_DESCRIPTION', "Payment method provided by Ginger Tooling.");
...
define('MODULE_PAYMENT_'.$method_name.'_STATUS_TEXT', "Enable Bancontact");
define('MODULE_PAYMENT_'.$method_name.'_STATUS_DESCRIPTION', "Do you want to enable Bancontact?");

define('MODULE_PAYMENT_'.$method_name.'_SORT_ORDER_TEXT', "Sort order for Bancontact");
...
define('MODULE_PAYMENT_'.$method_name.'_ERROR_ALREADY_INSTALLED', "The Bancontact module is already installed.");

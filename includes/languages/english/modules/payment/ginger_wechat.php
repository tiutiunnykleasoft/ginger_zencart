<?php
define('MODULE_PAYMENT_'.$method_name.'_STATUS', "False");
...
define('MODULE_PAYMENT_'.$method_name.'_STATUS_TEXT', "Enable WeChat");
define('MODULE_PAYMENT_'.$method_name.'_STATUS_DESCRIPTION', "Do you want to enable WeChat?");

define('MODULE_PAYMENT_'.$method_name.'_SORT_ORDER_TEXT', "Sort order for WeChat");
...
define('MODULE_PAYMENT_'.$method_name.'_ERROR_ALREADY_INSTALLED', "The WeChat module is already installed.");

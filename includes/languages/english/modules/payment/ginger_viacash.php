...
define('MODULE_PAYMENT_'.$method_name.'_TEXT_TITLE', "Viacash");
...
define('MODULE_PAYMENT_'.$method_name.'_STATUS_TEXT', "Enable Viacash");
define('MODULE_PAYMENT_'.$method_name.'_STATUS_DESCRIPTION', "Do you want to enable Viacash payment method?");

define('MODULE_PAYMENT_'.$method_name.'_SORT_ORDER_TEXT', "Sort order for Viacash");
...
define('MODULE_PAYMENT_'.$method_name.'_ERROR_ALREADY_INSTALLED', "The Viacash module is already installed.");

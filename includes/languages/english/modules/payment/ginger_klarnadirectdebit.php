...
define('MODULE_PAYMENT_'.$method_name.'_TEXT_TITLE', "Klarna Direct Debit");
define('MODULE_PAYMENT_'.$method_name.'_TEXT_DESCRIPTION', "Payment method is provided by Ginger Tooling.");
...
define('MODULE_PAYMENT_'.$method_name.'_STATUS_TEXT', "Enable Klarna Direct Debit");
define('MODULE_PAYMENT_'.$method_name.'_STATUS_DESCRIPTION', "Do you want to enable Klarna Direct Debit payment method?");

define('MODULE_PAYMENT_'.$method_name.'_SORT_ORDER_TEXT', "Sort order for Klarna Direct Debit");
...
define('MODULE_PAYMENT_'.$method_name.'_ERROR_ALREADY_INSTALLED', "The Klarna Direct Debit module is already installed.");

...
define('MODULE_PAYMENT_'.$method_name.'_TEXT_TITLE', "Credit/Debit Card");
...
define('MODULE_PAYMENT_'.$method_name.'_STATUS_TEXT', "Enable Credit/Debit Cards");
define('MODULE_PAYMENT_'.$method_name.'_STATUS_DESCRIPTION', "Do you want to enable Credit/Debit Cards?");

define('MODULE_PAYMENT_'.$method_name.'_SORT_ORDER_TEXT', "Sort order for Credit/Debit cards");
...
define('MODULE_PAYMENT_'.$method_name.'_ERROR_ALREADY_INSTALLED', "The Credit/Debit Card module is already installed.");

...
define('MODULE_PAYMENT_'.$method_name.'_TEXT_TITLE', "Credit Card");
...
define('MODULE_PAYMENT_'.$method_name.'_STATUS_TEXT', "Enable Credit Cards");
define('MODULE_PAYMENT_'.$method_name.'_STATUS_DESCRIPTION', "Do you want to enable Credit Cards?");

define('MODULE_PAYMENT_'.$method_name.'_SORT_ORDER_TEXT', "Sort order for Credit cards");

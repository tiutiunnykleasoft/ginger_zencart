...
define('MODULE_PAYMENT_'.$method_name.'_STATUS_TEXT', "Enable Klarna Pay Now");
define('MODULE_PAYMENT_'.$method_name.'_STATUS_DESCRIPTION', "Do you want to enable Klarna Pay Now?");

define('MODULE_PAYMENT_'.$method_name.'_SORT_ORDER_TEXT', "Sort order for Klarna Pay Now");
...
define('MODULE_PAYMENT_'.$method_name.'_ERROR_ALREADY_INSTALLED', "The Klarna Pay Now module is already installed.");

...
define('MODULE_PAYMENT_'.$method_name.'_TEXT_TITLE', "Swish");
...
define('MODULE_PAYMENT_'.$method_name.'_STATUS_TEXT', "Enable Swish");
define('MODULE_PAYMENT_'.$method_name.'_STATUS_DESCRIPTION', "Do you want to enable Swish payment method?");

define('MODULE_PAYMENT_'.$method_name.'_SORT_ORDER_TEXT', "Sort order for Swish");
...
define('MODULE_PAYMENT_'.$method_name.'_ERROR_ALREADY_INSTALLED', "The Swish module is already installed.");

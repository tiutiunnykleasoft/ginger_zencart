...
define('MODULE_PAYMENT_'.$method_name.'_TEXT_TITLE', "Sofort");
...
define('MODULE_PAYMENT_'.$method_name.'_STATUS_TEXT', "Enable Sofort");
define('MODULE_PAYMENT_'.$method_name.'_STATUS_DESCRIPTION', "Do you want to enable Sofort payment method?");

define('MODULE_PAYMENT_'.$method_name.'_SORT_ORDER_TEXT', "Sort order for Sofort");
...
define('MODULE_PAYMENT_'.$method_name.'_ERROR_ALREADY_INSTALLED', "The Sofort module is already installed.");

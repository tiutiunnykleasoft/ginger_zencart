...
define('MODULE_PAYMENT_'.$method_name.'_STATUS_TEXT', "Enable Google Pay");
define('MODULE_PAYMENT_'.$method_name.'_STATUS_DESCRIPTION', "Do you want to enable Google Pay?");

define('MODULE_PAYMENT_'.$method_name.'_SORT_ORDER_TEXT', "Sort order for Google Pay");
...
define('MODULE_PAYMENT_'.$method_name.'_ERROR_ALREADY_INSTALLED', "The Google Pay module is already installed.");

...
define('MODULE_PAYMENT_'.$method_name.'_TEXT_TITLE', "Giropay");
...
define('MODULE_PAYMENT_'.$method_name.'_STATUS_TEXT', "Enable Giropay");
define('MODULE_PAYMENT_'.$method_name.'_STATUS_DESCRIPTION', "Do you want to enable Giropay payment method?");

define('MODULE_PAYMENT_'.$method_name.'_SORT_ORDER_TEXT', "Sort order for Giropay");
...
define('MODULE_PAYMENT_'.$method_name.'_ERROR_ALREADY_INSTALLED', "The Giropay module is already installed.");

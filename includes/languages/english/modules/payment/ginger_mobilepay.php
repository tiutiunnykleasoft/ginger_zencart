...
define('MODULE_PAYMENT_'.$method_name.'_TEXT_TITLE', "MobilePay");
...
define('MODULE_PAYMENT_'.$method_name.'_STATUS_TEXT', "Enable MobilePay");
define('MODULE_PAYMENT_'.$method_name.'_STATUS_DESCRIPTION', "Do you want to enable MobilePay payment method?");

define('MODULE_PAYMENT_'.$method_name.'_SORT_ORDER_TEXT', "Sort order for MobilePay");
...
define('MODULE_PAYMENT_'.$method_name.'_ERROR_ALREADY_INSTALLED', "The MobilePay module is already installed.");

...
define('MODULE_PAYMENT_'.$method_name.'_STATUS_TEXT', "Aktivieren Payconiq");
define('MODULE_PAYMENT_'.$method_name.'_STATUS_DESCRIPTION', "Wollen Sie Payconiq aktivieren?");

define('MODULE_PAYMENT_'.$method_name.'_SORT_ORDER_TEXT', "Sortierreihenfolge für Payconiq");
...
define('MODULE_PAYMENT_'.$method_name.'_ERROR_ALREADY_INSTALLED', "Das Payconiq-Modul ist bereits installiert.");

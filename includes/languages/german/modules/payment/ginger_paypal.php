...
define('MODULE_PAYMENT_'.$method_name.'_STATUS_TEXT', "Aktivieren PayPal");
define('MODULE_PAYMENT_'.$method_name.'_STATUS_DESCRIPTION', "Wollen Sie PayPal aktivieren?");

define('MODULE_PAYMENT_'.$method_name.'_SORT_ORDER_TEXT', "Sortierreihenfolge für PayPal");
...
define('MODULE_PAYMENT_'.$method_name.'_ERROR_ALREADY_INSTALLED', "Das PayPal-Modul ist bereits installiert.");

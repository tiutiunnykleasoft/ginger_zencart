...
define('MODULE_PAYMENT_'.$method_name.'_STATUS_TEXT', "Aktivieren Bancontact");
define('MODULE_PAYMENT_'.$method_name.'_STATUS_DESCRIPTION', "Wollen Sie Bancontact aktivieren?");

define('MODULE_PAYMENT_'.$method_name.'_SORT_ORDER_TEXT', "Sortierreihenfolge für Bancontact");
...
define('MODULE_PAYMENT_'.$method_name.'_ERROR_ALREADY_INSTALLED', "Das Bancontact-Modul ist bereits installiert.");

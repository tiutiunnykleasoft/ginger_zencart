...
define('MODULE_PAYMENT_'.$method_name.'_STATUS_TEXT', "Aktivieren Klarna Pay Now");
define('MODULE_PAYMENT_'.$method_name.'_STATUS_DESCRIPTION', "Wollen Sie Klarna Pay Now aktivieren?");

define('MODULE_PAYMENT_'.$method_name.'_SORT_ORDER_TEXT', "Sortierreihenfolge für Klarna Pay Now");
...
define('MODULE_PAYMENT_'.$method_name.'_ERROR_ALREADY_INSTALLED', "Das Klarna Pay Now-Modul ist bereits installiert.");

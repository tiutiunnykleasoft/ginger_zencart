...
define('MODULE_PAYMENT_'.$method_name.'_STATUS_TEXT', "Aktivieren American Express");
define('MODULE_PAYMENT_'.$method_name.'_STATUS_DESCRIPTION', "Wollen Sie American Express aktivieren?");

define('MODULE_PAYMENT_'.$method_name.'_SORT_ORDER_TEXT', "Sortierreihenfolge für American Express");
...
define('MODULE_PAYMENT_'.$method_name.'_ERROR_ALREADY_INSTALLED', "Das AMEX is bereits installiert.");

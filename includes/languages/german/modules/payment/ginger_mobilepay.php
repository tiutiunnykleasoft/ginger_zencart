...
define('MODULE_PAYMENT_'.$method_name.'_STATUS_TEXT', "Aktivieren MobilePay");
define('MODULE_PAYMENT_'.$method_name.'_STATUS_DESCRIPTION', "Wollen Sie MobilePay aktivieren?");

define('MODULE_PAYMENT_'.$method_name.'_SORT_ORDER_TEXT', "Sortierreihenfolge für MobilePay");
...
define('MODULE_PAYMENT_'.$method_name.'_ERROR_ALREADY_INSTALLED', "Das Mobilepay is bereits installiert.");

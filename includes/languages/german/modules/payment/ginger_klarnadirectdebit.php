...
define('MODULE_PAYMENT_'.$method_name.'_TEXT_DESCRIPTION', "Die Zahlungsmethode wird bereitgestellt von Ginger Tooling.");
...
define('MODULE_PAYMENT_'.$method_name.'_STATUS_TEXT', "Aktivieren Klarna Direct Debit");
define('MODULE_PAYMENT_'.$method_name.'_STATUS_DESCRIPTION', "Wollen Sie Klarna Direct Debit aktivieren?");

define('MODULE_PAYMENT_'.$method_name.'_SORT_ORDER_TEXT', "Sortierreihenfolge für Klarna Direct Debit");
...
define('MODULE_PAYMENT_'.$method_name.'_ERROR_ALREADY_INSTALLED', "Das Klarna Direct Debit is bereits installiert.");

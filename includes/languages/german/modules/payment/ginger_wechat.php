...
define('MODULE_PAYMENT_'.$method_name.'_STATUS_TEXT', "Aktivieren WeChat");
define('MODULE_PAYMENT_'.$method_name.'_STATUS_DESCRIPTION', "Wollen Sie WeChat aktivieren?");

define('MODULE_PAYMENT_'.$method_name.'_SORT_ORDER_TEXT', "Sortierreihenfolge für WeChat");
...
define('MODULE_PAYMENT_'.$method_name.'_ERROR_ALREADY_INSTALLED', "Das WeChat is bereits installiert.");

...
define('MODULE_PAYMENT_'.$method_name.'_STATUS_TEXT', "Aktivieren Tikkie Payment Request");
define('MODULE_PAYMENT_'.$method_name.'_STATUS_DESCRIPTION', "Wollen Sie Tikkie Payment Request aktivieren?");

define('MODULE_PAYMENT_'.$method_name.'_SORT_ORDER_TEXT', "Sortierreihenfolge für Tikkie Payment Request");
...
define('MODULE_PAYMENT_'.$method_name.'_ERROR_ALREADY_INSTALLED', "Das Tikkie is bereits installiert.");

...
define('MODULE_PAYMENT_'.$method_name.'_STATUS_TEXT', "Aktivieren Sofort");
define('MODULE_PAYMENT_'.$method_name.'_STATUS_DESCRIPTION', "Wollen Sie Sofort aktivieren?");

define('MODULE_PAYMENT_'.$method_name.'_SORT_ORDER_TEXT', "Sortierreihenfolge für Sofort");
...
define('MODULE_PAYMENT_'.$method_name.'_ERROR_ALREADY_INSTALLED', "Das SOFORT is bereits installiert.");
